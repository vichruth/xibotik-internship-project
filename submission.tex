...
TTS & Piper, \texttt{en\_US-lessac-medium}, CPU & Lightweight VITS model, \textasciitilde50--
100\,ms to synthesize a sentence. Deliberately kept on CPU so the 6\,GB GPU is shared only
